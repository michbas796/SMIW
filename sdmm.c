...
#define CS_LOW()	PORTB &= ~0b00010000			/* CS=low */
#define	CS_HIGH()	PORTB |= 0b00010000			/* CS=high */
#define MMC_CD		(!(PINB & 0x04))	/* Card detected.   yes:true, no:false, default:true */
#define MMC_WP		(PINB & 0x08)		/* Write protected. yes:true, no:false, default:false */
...
void power_off (void)
{
	...
	DDRB  &= ~0b10110000;	/* Set SCK/MOSI/CS as hi-z, INS#/WP as pull-up */
	PORTB &= ~0b10110000;
	PORTB |=  0b00001100;
